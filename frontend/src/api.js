...
export const register = (username, password, name, admin, clienteId, tecnicoId) =>
  api.post('/auth/register', { username, password, name, admin, clienteId, tecnicoId }).then(r => r.data)
